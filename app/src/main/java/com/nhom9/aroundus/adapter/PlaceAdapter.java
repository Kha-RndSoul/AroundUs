...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.PlaceViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PlaceViewHolder holder, int position) {
        ...
        // Hiển thị ảnh đầu tiên trong imageUrls bằng Glide, nếu rỗng thì để nền xám mặc định
        ...
        // Nhấn icon tim trên card thì toggle yêu thích không cần vào trang chi tiết
        ...
        // Nhấn vào card thì mở trang chi tiết
